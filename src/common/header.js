...
import { Row, Col, Tabs, Icon, Input, Button, Badge } from 'antd';
    ...
    render(){
        return(
            <div className={style.header}>
                <Row>
                    <Col span={6}>
                        <div className={style.headerleft} align='left'>
                            欢迎您！
                    ...
                    <Col span={18}>
                        <div align='right' className={style.headerright}>
                ...
                <Row>
                    <Col span={6}>
                        <img src='/static/d/logo.png' alt='' className={style.logo} />
                    </Col>
                    <Col span={10}>
                        <Tabs defaultActiveKey='2' className={style.logomiddle}>
